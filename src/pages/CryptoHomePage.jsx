...
const FAQ_LD = {
  ...
  mainEntity: [
    ...
    ['Does this work on the Delta Exchange mobile app?', 'Yes. Enforcement is server-side via Delta Exchange’s API, so it works whether you trade from web, mobile, or a third-party client. We detect a trade within ~120ms and act if it breaks a rule. Alerts go to Telegram or email.'],
