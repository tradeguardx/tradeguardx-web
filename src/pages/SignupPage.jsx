...
const planMeta = {
  ...
  pro:     { label: 'Pro',  cls: 'bg-accent/15 text-accent border-accent/25' },
  free:    { label: 'Free', cls: 'bg-slate-500/15 text-slate-300 border-slate-500/25' },
};
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-16 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full bg-purple-500/[0.04] blur-[140px]" />
      </div>
        ...
        <div className="rounded-2xl border border-surface-700/50 bg-surface-900/70 backdrop-blur-xl p-7 sm:p-8 shadow-xl shadow-black/25">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-2.5 mt-2.5">
                  <div className="flex gap-1 flex-1">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className={`h-1 flex-1 rounded-full transition-all duration-300 ${i <= str.n ? str.cls : 'bg-surface-700/60'}`}
                      />
                    ))}
                  </div>
            ...
            <p className="text-[11px] text-slate-700 text-center leading-relaxed pt-1">
              ...
              {' '}&{' '}
              <Link to="/privacy" className="text-slate-500 hover:text-slate-400 underline underline-offset-2">Privacy Policy</Link>.
            </p>
          </form>
        </div>
