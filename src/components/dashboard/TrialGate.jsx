...
/**
 * Thin banner shown while the 3-day full-access trial is running.
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center text-center">
      ...
      <p className="mt-3 text-sm leading-relaxed" style={{ color: 'var(--dash-text-secondary)' }}>
        You had 3 days of full access. To keep your guardrails running and configure your rules, upgrade to a paid plan.
      </p>
