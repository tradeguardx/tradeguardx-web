    ...
    >
      ...
      <div className={`relative rounded-2xl p-[1px] bg-gradient-to-br ${tierStyle.frame}`}>
        <motion.div
          ...
          animate={{ opacity: [0.35, 0.75, 0.35], scale: [0.96, 1.02, 0.96] }}
          transition={{ duration: 4.5, repeat: Infinity, ease: 'easeInOut' }}
        />

        <div className="group/card relative overflow-hidden rounded-[15px] bg-[#0a0f1c]/98 shadow-[inset_0_1px_0_rgba(255,255,255,0.07)]">
          {/* Hover shimmer sweep */}
          <div
            aria-hidden
          ...
          <motion.div
            ...
            animate={{ opacity: [0.35, 0.7, 0.35], scale: [1.08, 1, 1.08] }}
