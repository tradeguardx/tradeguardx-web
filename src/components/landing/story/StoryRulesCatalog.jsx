...
const RULES = [
  {
    ...
    savesFrom: 'Bleeding past your daily loss limit in one session — the fastest way to blow up an account.',
  ...
  },
  {
    ...
    savesFrom: 'Total drawdown beyond your ceiling — the hard stop that ends accounts for good.',
  ...
  },
  {
    ...
    savesFrom: 'Trading straight through a loss streak — the tilt and revenge cycle that drains accounts.',
